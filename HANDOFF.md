...
| 产物 | `handbook/` 下 13 个 md + `images/` 122 张图 + `trading-handbook.html`（单文件阅读版）+ `trading-handbook.pdf`（打印版） |
| 当前指标 | PDF 302 页、122 图全嵌入、书签 218 项、页脚页码；审计全绿（交叉引用悬空 0、图注 122/122 一一对应、图号连续无重复） |
...
- 第 4 章：4.1 信号≠系统（已补 4.2 六要素可覆盖）、4.20 状态调整（**4.10/4.11/4.14/4.16/4.17 已补，批次 47 完成；4.9/4.12/4.18/4.19/4.2 已补，批次 46 完成**）
...
- 批次 48+ 建议从 P0 补图开始，每批 3-5 张图 + 审计 + PDF + 推送；图多时拆两批（画图/审计推送）
