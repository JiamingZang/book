...
| 产物 | `handbook/` 下 13 个 md + `images/` 126 张图 + `trading-handbook.html`（单文件阅读版）+ `trading-handbook.pdf`（打印版） |
| 当前指标 | PDF 304 页、126 图全嵌入、书签 218 项、页脚页码；审计全绿（交叉引用悬空 0、图注 126/126 一一对应、图号连续无重复） |
