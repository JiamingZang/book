...
**答案**：① 好交易（7.1）——评价标准是“是否一致执行了正期望值系统”，不是单笔盈亏；② 区间突破约 80% 失败；一般反转尝试约 80% 失败变旗形；90% 的 K 线下一笔胜率在 40-60%（盈亏比 ≥2 是数学底线）；③ 把决策从“感觉”手里夺回来（7.2 损失厌恶/处置效应）——人在浮亏时大脑会祈祷而不是判断，止损单让机器替你做决定。
