...
> **阅读提示**：本章不是 K 线字典，而是回答一个问题：**一根 K 线、一个关键位、一段趋势，分别是哪群人在什么情况下被迫行动留下的痕迹？** 之后每一章的策略都是用这套“读痕迹”的方法写成的。建议配合图 2-1~2-15 逐图读，读到能指着一根 K 线说出“谁在赢、谁被套”为止；读图时想不起某个概念，随时回本章查。正文中括号标注的人名（Brooks、Ali 等）是观点/资料来源，不是新术语——每人一节收录在附录 C（大 V 参考）。
...
**K 线的二维分类（YTC）：收盘比较定多空，收盘位置定强弱**。单根 K 线可以拆成两个独立问题：① **收盘比较**——收盘高于前一根 K 线区间高点 = 多头 K 线，低于前低 = 空头 K 线（这决定“观点”）；② **收盘位置**——收盘在自身区间顶部 1/3 内 = 高位收盘，底部 1/3 内 = 低位收盘（这决定“力度”）。组合起来：多头 K 线 + 高位收盘 = 强看涨；多头 K 线 + 低位收盘 = 疲弱看涨（有看涨观点但力度不足）；镜像同理。这个二维分类比“阳线/阴线”多出一档信息，而且完全可机械化——适合写进逐棒检查单。
...
**“重要低点”怎么定？** 本书建议用“波段低点”：左右各至少 1-2 根 K 线都高于它的低点；更稳一点要求至少 3 根 K 线形成（与 5.13 摆动范围一致）。别把盘中随机的小低点当结构点——只有波段级别的低点被跌破，才算趋势结构被破坏。
...
**缺口（Gap）**：相邻两根 K 线之间没有成交的空白（股票常见，因为隔夜休市；外汇只有周一开盘有）。先别背四类名字，先问：**一个价格真空出现在哪段行情，说明当时的供需发生了什么？** 答案决定它会不会回补：

- **普通缺口**：出现在区间内——价格还在均衡里，真空只是噪音。区间上下都有订单等着成交，价格离开真空后很快被拉回，所以大概率回补。
- **突破缺口**：出现在放量突破时——价格第一次离开旧均衡，真空是“新失衡的起点”。突破方有持续跟进，短期不回补；回补 = 突破失败。
- **持续缺口**：出现在趋势中段——失衡仍在进行，真空是“价格跑得太快、没人来得及挂单”的证明。只要趋势方还在，缺口就继续开放。
- **衰竭缺口**：出现在趋势末端——放量却无后续，说明最后一批追价者已经进场，真空之后没有新燃料，价格回头去填这个真空。

所以“位置决定性质”不是一句口诀，而是供需的必然：**真空出现在均衡里会被填，出现在失衡起点是信号，出现在失衡中段是加速，出现在失衡末端是离场提醒。** 考核期注意周一开盘缺口直接跳过你的止损（第 1.7 周末持仓问题）——这既是风险，也是机会：如果你知道缺口会回补，周一的跳空往往提供短期的回补交易，但别在考核期冒险（第 7 章军规）。
...
**缺口的“锚点 K 线”怎么选（Z说交易）**：不是所有空隙都值得当支撑阻力。Z说给出可重复的锚点清单：**光头阴线**（几乎无上影，开盘即单边抛售）被连续阳线突破并跟随后，形成的缺口是最干净的一种；**光脚阳线/长下影阳线/长上影阴线**各自对应不同形态的被套盘。机制：缺口强度来自被套者成本区的集中度——哪根 K 线被突破，那根 K 线上被套的人就在那里等解套；K 线越“干净”（影线越短），说明当时单边越彻底，被套盘越集中，价格回来时解套压力越大。这把缺口从“事后画线”变成可重复的支撑阻力识别规则。

**缺口与区间的同一条微观逻辑（Z说）**：**共识区域的中间是价值让步最多的地方，因此是最重要的价格**。缺口是买卖限价单都不愿意成交的真空，交易区间是双方达成共识的区域，区间中点就是让步最多、最容易被回测的价格。这条逻辑把缺口、区间、测量移动串成同一件事：价格离开真空/共识区越远，回来测试的磁力越强。

![图 2-10 缺口的锚点 K 线：左=光头阴线/光脚阳线/长下影阳线/长上影阴线四类干净 K 线；右=被突破后形成缺口，价格回来时被套盘集中解套](images/fig_p2_gap_anchor.png)

*图 2-10 缺口的锚点 K 线：K 线越干净，被突破后的缺口越有效*
...
![图 2-11 铁丝网（Barbwire）：紧凑重叠、绕 EMA 穿梭——大部分信号忽略，等待突破失败或极值短 K 线](images/fig_p2_barbwire.png)

*图 2-11 铁丝网（Barbwire）：紧凑重叠、绕 EMA 穿梭——大部分信号忽略，等待突破失败或极值短 K 线*
...
![图 2-12 洛氏 1-2-3 结构：低位做多（左）与高位做空（右），突破 2 点入场](images/fig_p2_123.png)

*图 2-12 洛氏 1-2-3 结构：低位做多（左）与高位做空（右），突破 2 点入场*
...
![图 2-13 洛氏霍克 Rh 与奇克入市法：回调到 Rh 附近限价入场，止损放 Rh 另一侧](images/fig_p2_ross_hook.png)

*图 2-13 洛氏霍克 Rh 与奇克入市法：回调到 Rh 附近限价入场，止损放 Rh 另一侧*
...
六条口诀（背下来，每次看图默念；每条后面是它背后的概率/结构依据，不是装饰）：

> 1. **先上下文，再形态**——同一个形态出现在趋势中段、区间边界、突破后，含义完全不同；脱离上下文的形态只是随机噪音。
> 2. **先信号质量，再入场计划**——信号棒质量决定“这笔该不该做”，入场计划只是“怎么做”；先花最便宜的判断否决坏信号，别让昂贵的计划细节绑架你进场。
> 3. **先二次入场，再评估反转诊断（逆势不下单）**——首次反转尝试的成功率只有约 35-40%，大多数第一次尝试会失败变旗形/区间；所以“像反转”不等于“可交易”，等二次入场等于把大概率失败的第一次让给别人。
> 4. **先跟随，再确认可交易**——K 线收盘本身不产生利润，后续 1-2 根是否同向推进才是“市场认不认可”的证据；没有跟随的信号只是信号，不是交易。
> 5. **先惯性，再逆势**——趋势的惯性是市场里最强的力量，绝大多数反转尝试最终失败；逆势只有在结构明确破坏、且出现二次确认后才允许，不是看到一根反向大 K 线就反手。
> 6. **看不懂，就等下一根 K 线**——看不懂通常意味着市场处于铁丝网/极端混乱，那里单笔期望接近零甚至为负；等待不是错过，是保留本金去买下一笔看得懂的机会。
...
![图 2-14 逐棒检查单：每根 K 线收盘后的五步流程与六条口诀](images/fig_p2_checklist.png)

*图 2-14 逐棒检查单：每根 K 线收盘后的五步流程与六条口诀*
...
**高潮的算法化判定（AMA 技术文档）**：除了肉眼三件套，Ali 的 AMA 指标给了一个零延迟、可编程的版本——**牛高潮 = HH > LL × ClimaxFactor（默认因子 1.8）**，即当前腿的高点相对前一段回撤低点的距离，超过 1.8 倍才算“推得太远”。镜像用于熊高潮。这个因子的意义不是“1.8 是真理”，而是把“高潮 = 失衡过远”变成可回测的阈值；写规则书时可以用它统一主观分歧，再按品种重新校准。
...
![图 2-15 尖峰识别五标准与持续时间分级（左）；买进高潮四阶段序列与尖峰后三路径概率（右）](images/fig_p2_spike_climax.png)

*图 2-15 尖峰识别五标准与持续时间分级（左）；买进高潮四阶段序列与尖峰后三路径概率（右）*

**上面是合成示意，下面用真实数据把同一套流程走一遍**——BTC 1H，2026-07-14 ~ 07-16（数据源：Binance BTCUSDT 5m K 线重采样 1H）。一轮上涨走完了"尖峰 → 第二波衰竭 → 高潮 → 回调"的完整生命周期，图 2-15 的每一项识别标准都能在下面的真实数据里找到对应：
...
1. **尖峰五标准的真实样子（图 2-15 左半的实证）**：7/14 20:00-23:00 四连阳 +3.0%，逐条对照——① 实体大：启动 K 线是近 20 根均值的 6 倍；② 无重叠：22:00 开盘 63840 紧贴前收 63960、23:00 开盘 64305 高于前收；③ 短尾线：20:00 上影只有实体的 3%；④ 收盘创新高：四根 K 线收盘一路上移；⑤ 紧迫感：启动量 4.8 倍、量 3109 BTC。**不是每根大阳线都叫尖峰，这五条才是判据**。
