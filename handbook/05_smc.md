...
**真实案例：spring 反转上涨日（Binance BTCUSDT 5 分钟，2026-07-14）**——与 5-2R 的下跌日互为镜像，看 spring 之后市场如何一步步确认底部：
...
![图 5-2R 真实数据：扫流动性 → CHoCH → 下跌趋势日（BTC 5 分钟，2026-07-31，较 sweep 高点 -2.7%、全天 -3.1%）](images/fig_real_btc_sweep.png)

*图 5-2R 真实数据：sweep → CHoCH → 下跌趋势日（数据源：Binance BTCUSDT 5m K 线）*
...
![图 5-3R 真实数据：Kill Zones 实证——24 小时波动率与成交量分布（BTC 5m，2026-07-15 ~ 08-13，30 天）：纽约开盘 21-22 点波动率 1.30×/量能 1.72× 全天峰值，伦敦开盘 15-16 点 1.05-1.09× 次峰，亚盘 4-7 点波动率 0.83-0.88×/量能 0.58-0.79× 谷底——Kill Zone 是信号密集窗口的实证，不是开关](images/fig_real_ch5_killzones.png)

*图 5-3R 真实数据：Kill Zones 24 小时分布（数据源：Binance BTCUSDT 5m K 线）*
...
![图 5-4R 真实数据：Volume Profile——HVN 堆积、LVN 快速区、POC 磁力（BTC 5 分钟，2026-08-11 ~ 08-13）](images/fig_real_volprof.png)

*图 5-4R 真实数据：Volume Profile（数据源：Binance BTCUSDT 5m K 线）*
