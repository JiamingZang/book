...
三组镜像对照着记：① 启明星/黄昏星是“大 K 线 + 犹豫的星 + 反吞”的节奏反转；② 红三兵/三乌鸦是“步步为营”的趋势启动；③ 平头是“同一价位两次被拒”的位置确认。共同原则：**单根形态讲“形态”，组合形态讲“节奏”——但都要有位置和背景**（呼应 4.2 信号质量 = 背景×位置×形态）。
...
- **矩形（Rectangle）**：价格在两条平行水平线之间反复横跳的整理形态（学委知识库补充术语）——本质是**没有楔形收敛的旗形**：上沿阻力、下沿支撑都清晰，来回摆动 3 次以上。操作与区间交易完全一致（第 4.4 系统二）：**边界反手、突破才追、突破需放量确认**。矩形突破后按形态高度投射量度目标（MM）。矩形和楔形的区别只在边线：矩形两条边平行水平，楔形两条边收敛。趋势中段的矩形 = 旗形换挡（延续），趋势末端的宽矩形 = 最终旗形（警惕反转，呼应 3.9 MTR）。
