...
![图 3-1R 真实数据：凌晨冲高诱多 → 放量下跌 → 破位加速（BTC 5 分钟，2026-07-08，全天 -3.5%）](images/fig_real_fakeout.png)

*图 3-1R 真实数据：冲高诱多 → 下跌日（数据源：Binance BTCUSDT 5m K 线）*

真实的一天，把 3.1-3.2 的框架走一遍：① **背景**：7/07 收 63764，7/08 凌晨开盘 63930——前期无明确趋势，上方 64000 一带是多次测试的阻力（7/06-7/07 的高点区），属于"位置一般"的追多环境；② **假突破**：01:45 冲到 64232 扫掉 64000 上方追多止损，但随后 2 小时收回 63600——突破失败，诱多成立，此时**只停止做多，不急着反手**；③ **第一次确认**：09:35 放量阴线（V=264）跌破早盘平台 63300，动能转空——这是顺势做空的第一入场点；④ **破位加速**：15:30 反抽 62900 失败，16:30-17:30 放量（V=282/668）跌破前低——第二次做空机会（破位后的回抽）；⑤ **纪律**：尾盘低点 61545，全天 -3.5%，反弹到前低下方才是空头加仓点，追跌不划算。五个步骤全是收盘确认，没有一次"抢跑"。
...
![图 3-2R 真实数据：巨量锤子线——下影 494 点 ≈ 4 倍实体，V=1551 全天最大（BTC 5 分钟，2026-07-01）](images/fig_real_pinbar.png)

*图 3-2R 真实数据：巨量锤子线实拍（数据源：Binance BTCUSDT 5m K 线）*

把上面的规则套进真实的一根 K 线：① **形态**：09:10 这根 K 线开 58294、最低 57800、收 58170——下影 494 点，实体只有 124 点，下影 ≈ 4 倍实体，教科书级锤子线；② **量**：V=1551 是全天最大量，是平常 K 线的 10-30 倍——巨量 + 长下影 = 空头全力砸盘被多头全盘接住，这是信号可信度的第一权重（3.6 量价确认）；③ **位置**：砸到的 57800 正是 7/01 早盘多次测试的平台下沿，支撑位下方的插针（呼应 3.2 的"支撑下方反转更高概率"）；④ **确认与入场**：09:35-09:40 连续放量大阳线（V=255/173）突破 58500——锤子线确认成立，入场点在突破 58298（锤子线高点）或影线 50% 位回调挂单，止损 57800 下方；⑤ **结果**：后续 HH/HL 一路走到 59457（见图 2-2R 同一天的趋势结构）。注意失败情形也一样真实——锤子线出现后若 09:35 没有放量确认而是跌破 57800，这根锤子线就只是下跌中继。
