...
![图 3-6 蜡烛组合形态六连图：启明星/黄昏星、红三兵/三乌鸦、平头顶/底——多根 K 线"合谋"（合成示意）](images/fig_p3_combo_bars.png)

*图 3-6 蜡烛组合形态六连图：启明星/黄昏星、红三兵/三乌鸦、平头顶/底——多根 K 线"合谋"（合成示意）*
...
![图 3-7 反转形态的统一框架：头肩顶 = HH MTR + LH MTR 的拼图；双顶熊旗（第二顶相同或更低 + 隐含低点）；MTR 四组件缺一不可（合成示意）](images/fig_p3_mtr.png)

*图 3-7 反转形态的统一框架：头肩顶 = HH MTR + LH MTR 的拼图；双顶熊旗（第二顶相同或更低 + 隐含低点）；MTR 四组件缺一不可（合成示意）*
...
![图 3-8 楔形回撤 vs 楔形反转：顺大势的楔形是入场机会，趋势末端的楔形是反转预警](images/fig_p3_wedge_contrast.png)

*图 3-8 楔形回撤 vs 楔形反转：顺大势的楔形是入场机会，趋势末端的楔形是反转预警*
...
![图 3-9 突破的四种结果：成功/回调/失败/反转——所有影线都是失败的突破](images/fig_p3_breakout_four.png)

*图 3-9 突破的四种结果：成功/回调/失败/反转——所有影线都是失败的突破*
...
![图 3-10 突破后必有测试：价格折返突破点，四批人共同决策，票多的赢、票少的输](images/fig_p3_testing.png)

*图 3-10 突破后必有测试：价格折返突破点，四批人共同决策，票多的赢、票少的输*
...
![图 3-11 最终旗形：趋势末段的旗形突破失败，反转概率约 40%，反转幅度常与趋势等长](images/fig_p3_final_flag.png)

*图 3-11 最终旗形：趋势末段的旗形突破失败，反转概率约 40%，反转幅度常与趋势等长*
...
![图 3-12 高1/高2 计数：第一次回调突破前棒高点=H1，第二次回调突破前棒高点=H2——反转/边界场景必须等 H2](images/fig_p3_h1h2.png)

*图 3-12 高1/高2 计数：第一次回调突破前棒高点=H1，第二次回调突破前棒高点=H2——反转/边界场景必须等 H2*
...
![图 3-13 楔形三推：P1/P2/P3 依次推进后破位，上升楔形向下破（破位概率约 75%）](images/fig_p3_wedge_p3.png)

*图 3-13 楔形三推：P1/P2/P3 依次推进后破位，上升楔形向下破（破位概率约 75%）*
...
![图 3-14 测量移动：Leg 1 = Leg 2，第一段长度投射第二段目标位](images/fig_p3_measured_move.png)

*图 3-14 测量移动：Leg 1 = Leg 2，第一段长度投射第二段目标位*
...
![图 3-15 开盘反转：开盘 60-90 分钟窗口内假突破前高后收回，失败率 > 70% 后反向](images/fig_p3_opening_reversal.png)

*图 3-15 开盘反转：开盘 60-90 分钟窗口内假突破前高后收回，失败率 > 70% 后反向*
