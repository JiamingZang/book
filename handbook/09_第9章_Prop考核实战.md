...
- 第 1-2 周：15 笔，胜率 40%，盈亏比 2.2，盈利 +3.2%。（中间连亏 2 笔，休息一天）
- 第 3-4 周：14 笔，盈利 +2.8%。累计 +6%。
- 第 5-6 周：13 笔，盈利 +2.5%。累计 +8.5%。
- 第 7-8 周：12 笔，盈利 +1.8%。累计 +10.3%，通过 Phase 1。共 54 笔，约 2 个月。
- Phase 2：目标 5%，同样方法，约 1 个月通过。
- Funded：保持 0.5% 风险，首月盈利 +4%，出金 80% 分成。

**关键**：全程无重仓、无报复、无违规。慢，但每一步都稳。这就是"慢就是快"——10.3% 的达标不靠某笔爆发，靠 54 笔的稳定累积。

**案例的解读**：注意胜率只有 40%、每笔平均 0.2R——这个案例没有任何"天才操作"，全是数学的必然。54 笔 × 0.2R × 0.5% ≈ 5.4%……等等，为什么实际累计 10.3%？因为盈亏比 2.2 略高于假设的 2，且中间无回撤浪费（连亏 2 笔后休息，没有放大亏损段）。这就是"小优势 × 大样本"的力量：每笔 0.1% 的期望，54 笔后变成 10% 的确定性结果。
