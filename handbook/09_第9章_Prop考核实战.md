...
**关键**：全程无重仓、无报复、无违规。慢，但每一步都稳。这就是"慢就是快"——10.0% 的达标不靠某笔爆发，靠 72 笔的稳定累积。

**案例的解读**：注意胜率只有 40%、盈亏比 2.2——每笔期望 = 0.4×2.2 − 0.6×1 = 0.28R，即每笔期望收益率 0.28 × 0.5% ≈ 0.14%。72 笔 × 0.14% ≈ 10.1% ≈ 10%——达标不是靠某笔爆发，而是“小优势 × 大样本”的确定性累积，全程无回撤浪费（连亏 2 笔后休息，没有放大亏损段）。盈亏比 2.2 略优于 9.3 的基准假设（RR=2，期望 0.1%/笔、需 80 笔），所以 72 笔就够——这就是“略高的盈亏比 + 稳定执行”带来的时间差。
...
**一个补充：季节性（日历观察，仅供参考）**：Brooks 提到过几个有统计依据的日历规律：全年收盘价高于开盘价的年份占 67%；"1 月晴雨表"——1 月上涨则全年上涨概率 82%、2-12 月平均涨幅 8.5%，1 月下跌则全年 58% 概率下跌、2-12 月平均涨幅仅 1.7%；"五月卖出走开"——美股大部分涨幅集中在 10 月到次年 4 月；9 月是标普最弱月份（但平均只比其他月份差 1%，且这一天随时可能来）。**Brooks 自己的态度：这些统计有效，但对构建单笔交易没有帮助**——它们影响的是你"什么时候启动考核、什么时候给自己放假的预期管理"，不是"这笔单要不要进"。别把季节当信号，把它当日历。
