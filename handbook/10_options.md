...
![图 10-8 期权放回全书坐标：观点来自价格行为（中心），期权负责把方向、风险、波动率、时间四个维度变成可管理的工具](images/fig_p10_options_coord.png)

*图 10-8 期权放回全书坐标：期权不改变观点，只改变观点的成本、风险与收益形状*
...
![图 10-9 Brooks 的期权极简主义：左=极简工具树（价格行为 → Call/Put/价差）；右=隔夜用期权锁死跳空风险，入场判断完全来自价格行为](images/fig_p10_brooks_options.png)

*图 10-9 Brooks 的期权观：理解可以深，工具必须简单——注意力留给图表*
