...
3. **VRP 是长期常态，但恐慌期会反转**。全历史 10 年，80% 的交易日 IV > RV（平均 +2.5 个百分点）——“担心”长期被高估，这就是卖方长期收保险费的来源；但本图窗口（2026-03 ~ 08）只有 58% 为正，7 月阴跌期 RV 连续 3 周反超（最深 −8.6pct）——高波动窗口里溢价被压缩甚至消失。**卖方别忘了尾部风险**（呼应 6.3 连亏与 7.1 概率思维）：你收的是常态溢价，亏的是恐慌期一次性反超。
