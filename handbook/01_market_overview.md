...
![图 1-9 期货合约规格速查：ES/NQ/YM/CL/GC 每点价值与 tick + 四个核心机制（合约规格/tick 价值/到期换月/保证金）+ 新手从 ES 起步](images/fig_p1_futures_spec.png)

*图 1-9 期货合约规格速查：ES/NQ/YM/CL/GC 每点价值与 tick + 四个核心机制（合约规格/tick 价值/到期换月/保证金）+ 新手从 ES 起步*
...
![图 1-10 资产配置两条腿：交易账户（≤10-20%）进攻 + 配置账户防守；配置账户内部 60/40 再平衡（编者示例比例）](images/fig_p1_asset_allocation.png)

*图 1-10 资产配置两条腿：交易账户（≤10-20%）进攻 + 配置账户防守；配置账户内部 60/40 再平衡（编者示例比例）*
