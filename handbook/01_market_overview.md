...
> **阅读提示**：本章是全书的地基——先搞清“钱和市场怎么转”，再谈技术分析。内容包含参与者、订单撮合、点差滑点、品种与基金/A 股通识。新手建议完整读一遍；有经验可扫读 1.1–1.6 后直接进第 2 章；1.16–1.17 的基金与资产配置通识可按需查阅，不影响主线。正文中括号标注的人名（Brooks、Ali、南桥、Tefi 等）是观点/资料来源，不是新术语——每人一节收录在附录 C（大 V 参考）。
...
**订单镜像思维（Brooks）**：把任何市场先归类成“止损单市场”或“限价单市场”，然后假设**你的每一张订单，对面都站着一个方向相反的对手单**——你在前一根 K 线高点上方 1 tick 挂止损买单，对方很可能在同一个价位挂限价卖单；你用限价单在前高做空，对方很可能用止损单在更高处买。你永远不知道对手是谁，但这不重要：这个假设逼你换位思考“对面为什么愿意接我的单”——我的概率高，他就得有大的回报或小的风险作为补偿（交易者方程，2.5/6.7）。实战含义：① 止损单入场 = 顺着突破方向追，市场至少会朝你移动一个价格变动（概率高、止损远）；② 限价单入场 = 在区间/回调里等价格回来，成交后通常还有反转风险（概率低、止损近）；③ 每次突破（哪怕只是突破前一根 K 线高低点）都值得停下来评估成功或失败的可能性，因为你止损单的对家往往就是那个“知道自己在做什么”的机构。
...
**示例**：1 标准手 EURUSD ≈ $100,000 名义价值。1:30 杠杆下，占用保证金 ≈ $3,333。也就是说你用 $3,333 撬动了 $100,000 的头寸——价格每动 1%，头寸盈亏 $1,000，相对你的 $3,333 本金就是 1% × 30 = **30%**。这就是杠杆的定义：盈亏被放大了 30 倍（注意方向是"乘"不是"除"——后面 1.5 的爆仓算例和图 1-1R 都建立在这一步之上）。
...
**② 爆仓先于止损——这是高杠杆最阴险的地方。** 假设你是个守纪律的人，入场时挂了止损。20x 的爆仓线 58989 在 20:20 被击穿（V=502 放量）；如果你把止损设在日低 58201 下方（-3.8%，给足空间"别被扫"），爆仓比止损触发早了约 2 小时——**你根本没机会执行那个止损，平台先替你平了**。这正是 1.5 正文算例说的"止损还没触发（或刚触发就被强平），爆仓先来了"。
...
![图 1-4R 真实数据：下跌趋势中的尖峰陷阱 → 扫损 → 加速下跌——18:40 高点 65410 持续阴跌到 21:25 低点 64913；21:30-21:45 连续 3 根放量大阳尖峰冲到 65718（+1.2%，追多者入场）；21:50 第一根反向大阴拒绝；22:40 跌破尖峰起点扫损（-1.9%）；01:35 回测尖峰起点=逃命点；06:40 放量破位；09:05 最低 63059，距尖峰顶 -4.05%（BTCUSDT 5m，2026-07-27 18:30 ~ 07-28 09:30）](images/fig_real_ch1_spike_sweep.png)
...
2. **跌破尖峰起点 = 追高者的止损全部被扫**。22:40 价格跌破 64947（尖峰起点），所有在尖峰买入的人浮亏（从尖峰顶 65718 算已 -1.9%），止损盘被打掉后价格反而止跌回测——01:35 反弹到 65090（尖峰起点附近）就是标准的**逃命点**：被套的多头趁反弹走人，新空头则在这里进场（呼应 5.6 sweep：扫掉止损后回测确认）。
