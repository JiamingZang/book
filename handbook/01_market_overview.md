...
- **展期日（rollover day，Ali 补充）**：换月那天新旧两个合约同时在交易——**旧合约的成交量更高（成交量次日才转移到新合约）**；由于两者都在交易，两张图都呈现有效形态（无跳空缺口），但形态并非总是一致。操作建议：**同时观察两张图表，但优先交易成交量更大的旧合约**——成交量小的一方 K 线形态容易失真（低流动性下的价格不代表真实市场）；旧合约的形态才更准确反映市场真实走向。这也解释了为什么换月前一周开始，主力资金逐渐向新合约迁移、旧合约波动被放大。
