...
![图 1-1R 真实数据：BTC vs ETH 波动率对比——上=归一化价格同涨同跌；下=24h 滚动波动率（日均 1σ %），恐慌时飙升、平静时压缩（BTC/ETH 5 分钟，2026-06-29 ~ 08-13）](images/fig_real_ch1_vol.png)

*图 1-1R 真实数据：BTC vs ETH 波动率对比（数据源：Binance BTCUSDT/ETHUSDT 5m K 线）*
