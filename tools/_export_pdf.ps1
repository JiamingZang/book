...
& 'C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe' --headless --disable-gpu --no-pdf-header-footer '--user-data-dir=C:\Users\18315\AppData\Local\Temp\edgepdf3' "--print-to-pdf=$pdf" $uri
