# -*- coding: utf-8 -*-
"""图 1-2R 真实数据：BTC 时段活跃度（Binance 5m，2026-06-29 ~ 08-13）
...
# 时段图例（右上）
ax2.text(0.985, 0.97, "■ 美盘（北京22时-8时）   ■ 欧盘（15-22时）   ■ 亚盘（8-15时）",
...
# 统计框（左下）
stats = ("美盘（北京22时-8时）占全天成交量 52%，波动均值 80 点\n"
         "欧盘（15-22时）24%，亚盘（8-15时）23%，波动均值约 70 点\n"
         "峰值（5-6时）≈ 谷底（1时）的 2.2 倍\n"
